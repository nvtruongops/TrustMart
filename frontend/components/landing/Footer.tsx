...
export default function Footer() {
  return (
    <footer className="bg-brand-green text-white py-20 rounded-t-[3rem] mt-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-8 text-white/70 max-w-sm">
              Join our newsletter to get first dibs on premium drops and expert tips.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              <li><Link href="#" className="hover:text-brand-yellow transition-colors">Electronics</Link></li>
              <li><Link href="#" className="hover:text-brand-yellow transition-colors">Fashion</Link></li>
              <li><Link href="#" className="hover:text-brand-yellow transition-colors">Luxury Watches</Link></li>
              <li><Link href="#" className="hover:text-brand-yellow transition-colors">Sneakers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              ...
              <li className="flex items-center gap-3"><Mail className="w-5 h-5" /> hello@secondlife.com</li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-white/50">
          <p>&copy; 2026 SecondLife Inc. All rights reserved.</p>
